...
export const SBJ = [
  ...
  // ─── 주제선택 (1학년 전용) ───
  {id:'s18',name:'국어(주)',ci:1, gh:{1:1,2:0,3:0}},
  {id:'s19',name:'사회(주)',ci:3, gh:{1:1,2:0,3:0}},
  {id:'s20',name:'도덕(주)',ci:7, gh:{1:1,2:0,3:0}},
  {id:'s21',name:'수학(주)',ci:0, gh:{1:1,2:0,3:0}},
  {id:'s22',name:'과학(주)',ci:5, gh:{1:1,2:0,3:0}},
  {id:'s23',name:'진로(주)',ci:6, gh:{1:1,2:0,3:0}},
