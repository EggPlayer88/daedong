...
- [x] prefill 모드 (교과·학년별 작년 문서 기반 "달라진 것만 질문") — 2·3학년 23블록
      ※ 2학년 성취기준 2022 재선정본은 자산 대기 (마스터플랜 5-7)
      ※ 서·논술형 30% 해석 확인 필요 — 작년 실적 11건이 규정에 걸린다 (5-9)
- [x] 정기시험 평가방법 3분류 (선택형 / 단답형·완성형 / 서·논술형) — 30% 산입은
      서·논술형만. 작년 2분류 자료는 대화에서 나눠 받는다 (AI 임의 분배 금지)
- [x] 마스터 양식 v3 (정기 3분류 6열 + 수행 3열 + 출제계획 3블록, 토큰 169종) 배치·연결
- [x] 양식 패밀리 — 기본형·3학년형은 마스터(5수준), 예체능형(음악·미술·체육)은
      전용판 `template-arts.hwpx`(3수준 A~C). 보건·정보는 5수준이라 마스터 사용
- [ ] 자유학기형(1학년 2학기) 양식·수집 명세 — 마스터를 그대로 쓸 수 없다 (마스터플랜 5-7)
